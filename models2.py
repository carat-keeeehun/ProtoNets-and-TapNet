...
# from utils import nullspace_gpu
...
class TapNet(object):
    ...
    '''
    Chain consist of 4 residual blocks, and each block consist of 3x3 convolution, batch normalization,
    which is same architecture of ResNet 12.
    '''
